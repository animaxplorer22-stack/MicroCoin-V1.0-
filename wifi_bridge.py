#!/usr/bin/env python3
"""
MICROCORE (MCX) WIFI BRIDGE v5.0
...
async def connect_to_node():
    ...
    while running:
        # Update node list from bootstrap + cache
        if not node_urls:
...
async def main():
    print("\n" + "=" * 60)
    print("MICROCORE (MCX) WIFI BRIDGE v5.0")
